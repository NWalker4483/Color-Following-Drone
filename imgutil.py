...
def get_center(srcimg, minhsv, maxhsv, min_blob_radius=20, debug=True):
    srccopy = srcimg.copy()
    ...
    if len(contours) > 0:
        ...
        if radius > min_blob_radius:
            ...
            if debug:
                ...
                cv2.circle(srccopy,center,int(radius),(0,255,0),2)
                #cv2.line(srccopy,(cols-1,righty),(0,lefty),(0,255,0),2)
